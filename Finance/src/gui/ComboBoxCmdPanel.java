...
public class ComboBoxCmdPanel extends JPanel implements ActionListener  {
	
	JComboBox comboBox;
	ComboSubCmdInterface cmdInt;
	
	public ComboBoxCmdPanel(String[] strForChoice, int initCmbTxtValue, ComboSubCmdInterface cmdInt) {
